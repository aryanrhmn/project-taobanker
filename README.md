...
| Public / social claim | motion ≥ n/(12d³) | **UNSUPPORTED / WITHDRAWN** — no trusted extracted manuscript proves 1/12; it survives only in a script docstring and in quarantined mis-extractions, and your own `README_babai_motion_d5_audit.md` withdraws it. |
...
1. **Publicly claim n/(14d³), not n/(12d³) and not 2n/(5d³).** The 1/14 manuscript is the strongest fully-written, fully-audited claim in the package; 1/12 is withdrawn and unwritten; 2/5 is conditional on an unpublished preprint.
