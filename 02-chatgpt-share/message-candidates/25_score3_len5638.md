bash -lc cat > /mnt/data/babai_motion_d3_audited_scalar_check.py <<'PY'
#!/usr/bin/env python3
...
if __name__ == "__main__":
    main()
PY
chmod +x /mnt/data/babai_motion_d3_audited_scalar_check.py
python /mnt/data/babai_motion_d3_audited_scalar_check.py